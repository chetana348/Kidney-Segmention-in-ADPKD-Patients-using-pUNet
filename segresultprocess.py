...
from pUNet.util import removesmallConnectedCompont, morphologicaloperation
import numpy as np
import cv2
...
def removekidneysmallobj():
    ...
    :return:
    """
   data_path = "E:\Data\kidney_modify"
    result_path = "E:\Data\kidney_modify\\"
    """
    load itk image,change z Spacing value to 1,and save image mask ,tumor mask
    :return:None
    """
...
def remove2d3dtumorsmallobj():
    ...
    :return:
    """
    tumor3d_path = "E:\Data\kidney_modify"
    tumor2d_path = "E:\Data\kidney_modify"
    """
    load itk image,change z Spacing value to 1,and save image ,tumor mask
    :return:None
    """
    # step2 get all train image
